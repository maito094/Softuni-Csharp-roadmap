...
const catalogTemplate = (dataPromise, isUserPage) => html` <div
    class="row space-top"
  >
    <div class="col-md-12">
      ${isUserPage
...
export function catalogPage(ctx) {
  const isUserPage = ctx.pathname == '/my-furniture';
  ctx.render(catalogTemplate(loadItems(isUserPage), isUserPage));
}
